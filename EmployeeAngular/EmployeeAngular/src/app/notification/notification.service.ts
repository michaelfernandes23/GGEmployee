...
import { NotificationCountDTO, NotificationDTO } from './notification';  
...
export class NotificationService {  
  ...
  getNotificationCount(): Observable<NotificationCountDTO> {  
    ...
    return this.http.get<NotificationCountDTO>(url)  
      .pipe(  
        catchError(this.handleError)  
      );  
  }  
  
  getNotificationMessage(): Observable<Array<NotificationDTO>> {  
